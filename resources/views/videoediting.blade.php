...
<title>Video Editing - Digital Agency</title>
...
<div class="xs-inner-banner inner-banner2" style="background-image:url('assets/images/banner/video-edit.png')">
<div class="container">
<div class="row">
<div class="col-md-7 mx-auto">
<div class="inner-banner">
<h2 class="inner-banner-title">Video Editing</h2>
...
<section class="image-with-description">
    ...
    <div class="container">
        <div class="row align-items-center image-with-description-block">
            <div class="col-lg-6">
                <h2 style="font-size:2.8rem !important;">Video Editing Stages</h2>
                <p style="font-size:-0.2rem !important; font-family: cursive;">Video editing is the process of manipulating and rearranging video shots to create a new work. Editing is usually considered to be one part of the post production process — other post-production tasks include titling, colour correction, sound mixing, etc.
                </p>
                <ul class="common-list-items" style=" font-family: cursive;">
                    <li>
                        <i class="ml-tec-44-responsive-mobile-phone-tablet-computer-desktop-monitor-laptop"></i> Rearranging, adding and/or removing sections of video and audio clips.</li>
                    <li>
                        <i class="ml-tec-47-disc-device-plug-computer-desktop-monitor-laptop"></i> Applying colour correction, filters and other enhancements</li>
                    <li>
                        <i class="ml-tec-43-computer-desktop-monitor-laptop"></i> Creating transitions between clips.</li>
                </ul>
            ...
            <div class="col-lg-6 text-lg-right">
                <img src="images/services/video-edit.png" alt="web design description image" class="img-fluid">
            </div>
            <!-- End of .col-lg-6 -->
        </div>
        <!-- End of .row -->
...
<section class="our-process section-padding">
    <div class="container">
        ...
        <p class="section-subheading text-center" style="font-size: 1.4rem !important"> Video editing has been dramatically democratized in recent years by 
            <br>editing software available for personal computers.</p>
        ...
        <div class="service-process-tab">
            ...
            <div class="tab-content service-tab-content" id="service-tab">
                <div class="tab-pane fade show active" id="process-tab-1" role="tabpanel" aria-labelledby="process-nav-1">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/assembly.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>First Assembly</h4>
                            <p style="font-family: cursive;">The first assembly, or assembly cut, is the editor's first cut of the entire movie.</p>
                            <p style="font-family: cursive;">The editor strings together all of the usable footage and organizes it into a chronological sequence that corresponds with the film's script.</p>
                ...
                <div class="tab-pane fade" id="process-tab-2" role="tabpanel" aria-labelledby="process-nav-2">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/rough-cut.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>Rough Cut</h4>
                            <p style="font-family: cursive;">A rough cut is technically the first cut that can be presented to the film editor. In other words, it’s like a filmmaker’s version of the first working draft of a written document</p>
                            <p style="font-family: cursive;">the document isn’t yet ready to be presented, but it is an in-progress version of a product that needs refining. </p>
                            <a href="#" class="text-only-btn">Next Process
                                <i class="ml-symone-2-arrow-left-right-up-down-increase-decrease"></i>
                            </a>
                        </div>
                ...
                <div class="tab-pane fade" id="process-tab-3" role="tabpanel" aria-labelledby="process-nav-3">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/final-cut.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>Final Cut</h4>
                            <p style="font-family: cursive;">In Final Cut Pro, editing includes selecting clips and adding them to your project, arranging</p>
                            <p style="font-family: cursive;">clips in the timeline, and cutting and trimming clips.</p>
                            <a href="#" class="text-only-btn">Next Process
                                <i class="ml-symone-2-arrow-left-right-up-down-increase-decrease"></i>
                            </a>
                        </div>
        ...
        <div class="featured-project-showcase text-center">
            <div class="row equalHeightWrapper">
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/video-edit-cardenas.png" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">Video Editing</span>
                            Gym Tour Video
                        </h5>
                    </a>
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/b&b-powersports.png" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">Video Editing</span>
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/yossie-video.png" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">Video Editing</span>
                            Documentary Yossie Productions
                        </h5>
                    </a>
                    <!-- End of .featured-content-block -->
                </div>
