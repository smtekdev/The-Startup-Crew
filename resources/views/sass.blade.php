...
<title>SAAS - Digital Agency</title>
...
<div class="xs-inner-banner inner-banner2" style="background-image:url('assets/images/banner/saas.jpg')">
<div class="container">
<div class="row">
<div class="col-md-7 mx-auto">
<div class="inner-banner">
<h2 class="inner-banner-title">SAAS</h2>
...
<section class="image-with-description">
    ...
    <div class="container">
        <div class="row align-items-center image-with-description-block">
            <div class="col-lg-6">
                <h2 style="font-size:2.8rem !important;">SAAS Process</h2>
                <p style="font-size:-0.2rem !important; font-family: cursive;">Software as a service (or SaaS) is a way of delivering applications over the Internet—as a service. Instead of installing and maintaining software, you simply access it via the Internet, freeing yourself from complex software and hardware management.
                </p>
                <ul class="common-list-items" style=" font-family: cursive;">
                    <li>
                        <i class="ml-tec-44-responsive-mobile-phone-tablet-computer-desktop-monitor-laptop"></i> Accessibility and persistence</li>
                    <li>
                        <i class="ml-tec-47-disc-device-plug-computer-desktop-monitor-laptop"></i> Flexible payments</li>
                    <li>
                        <i class="ml-tec-43-computer-desktop-monitor-laptop"></i>Scalable usage</li>
                </ul>
            ...
            <div class="col-lg-6 text-lg-right">
                <img src="images/services/saas.jpg" alt="web design description image" class="img-fluid">
            </div>
            <!-- End of .col-lg-6 -->
        </div>
        <!-- End of .row -->
...
<section class="our-process section-padding">
    <div class="container">
        <h2 class="text-center" style="font-size: 3.5rem !important">Our Process</h2>
        <p class="section-subheading text-center" style="font-size: 1.4rem !important"> SaaS sales is the process of selling subscription access to cloud-hosted software products either to businesses, prosumers or consumers.</p>
        ...
        <div class="service-process-tab">
            <ul class="nav nav-tabs service-tab-nav" id="service-tab-nav" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" style="margin-left:-26% !important;" id="process-nav-1" data-bs-toggle="tab" href="#process-tab-1" role="tab" aria-controls="process-tab-1"
                        ...
                        <span>The self-service model</span>
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content service-tab-content" id="service-tab">
                <div class="tab-pane fade show active" id="process-tab-1" role="tabpanel" aria-labelledby="process-nav-1">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/theself.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>The Self-Service Model</h4>
                            <p style="font-family: cursive;">Much like the name suggests, you won’t be proactively selling SaaS to users in the self-service model. Instead of having a team of SaaS sales reps, you’ll rely on marketing efforts to drive traffic to your sales pipeline.</p>
                            <p style="font-family: cursive;">This is ideal for SaaS products with a lower price point and a simpler onboarding process.</p>
                ...
                <div class="tab-pane fade" id="process-tab-2" role="tabpanel" aria-labelledby="process-nav-2">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/transactional.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>Transactional Model</h4>
                            <p style="font-family: cursive;">As the price of your product increases, so does the customer acquisition cost. This is because people are less willing to part with a significant amount of their hard-earned cash unless they have a positive interaction with a sales rep from your company.</p>
                            <p style="font-family: cursive;">Many SaaS companies with a customer self-service model tend to transition towards transactional sales given time.</p>
                            <a href="#" class="text-only-btn">Next Process
                                <i class="ml-symone-2-arrow-left-right-up-down-increase-decrease"></i>
                            </a>
                        </div>
                ...
                <div class="tab-pane fade" id="process-tab-3" role="tabpanel" aria-labelledby="process-nav-3">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/enterprise.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>The Enterprise Model</h4>
                            <p style="font-family: cursive;">This SaaS sales model is often reserved for high-ticket, specialized software — and sales techniques often focus on outbound marketing rather than inbound marketing.</p>
                            <p style="font-family: cursive;">The main reason for the long sales cycle is the bureaucratic inertia that most enterprise companies deal with.</p>
                            <a href="#" class="text-only-btn">Next Process
                                <i class="ml-symone-2-arrow-left-right-up-down-increase-decrease"></i>
                            </a>
                        </div>
...
<section class="featured-projects section-padding">
    ...
    <div class="container">
        <h2 class="text-center" style="font-size:3.0rem !important;">Featured Work</h2>
        ...
        <div class="featured-project-showcase text-center">
            <div class="row equalHeightWrapper">
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/saas-pro1.jpg" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">SAAS Project</span>
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/saas-pro2.png" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">SAAS Project</span>
                            SAAS UX\UI Product Design
                        </h5>
                    </a>
                    <!-- End of .featured-content-block -->
                </div>
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/saas-pro3.jpg" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">SAAS Project</span>
                            Cloud CRM SAAS Service For Business
                        </h5>
                    </a>
                    <!-- End of .featured-content-block -->
                </div>
