...
<title>Graphic Design - Digital Agency</title>
...
<div class="xs-inner-banner inner-banner2" style="background-image:url('assets/images/banner/graphic-design.jpg')">
<div class="container">
<div class="row">
<div class="col-md-7 mx-auto">
<div class="inner-banner">
<h2 class="inner-banner-title">Graphic Design</h2>
...
<section class="image-with-description">
    ...
    <div class="container">
        <div class="row align-items-center image-with-description-block">
            <div class="col-lg-6">
                <h2 style="font-size:2.8rem !important;">Graphics Design Concept</h2>
                <p style="font-size:-0.2rem !important; font-family: cursive;">The graphic design process describes the different stages of a design project. It can be broken down into four sub-processes definition, creation, feedback, and delivery.
                </p>
                <ul class="common-list-items" style=" font-family: cursive;">
                    <li>
                        <i class="ml-tec-44-responsive-mobile-phone-tablet-computer-desktop-monitor-laptop"></i> The Creative Brief</li>
                    <li>
                        <i class="ml-tec-47-disc-device-plug-computer-desktop-monitor-laptop"></i> Refine Design</li>
                    <li>
                        <i class="ml-tec-43-computer-desktop-monitor-laptop"></i> Presenting</li>
                </ul>
            ...
            <div class="col-lg-6 text-lg-right">
                <img src="images/services/graphic.jpg" alt="web design description image" class="img-fluid">
            </div>
            <!-- End of .col-lg-6 -->
        </div>
        <!-- End of .row -->
...
<section class="our-process section-padding">
    <div class="container">
        ...
        <p class="section-subheading text-center" style="font-size: 1.4rem !important"> You probably used a simple Google search to research your competitors, which is definitely still an option. 
            <br>But in most cases, you should use alternative resources and as much data as possible.</p>
        ...
        <div class="service-process-tab">
            <ul class="nav nav-tabs service-tab-nav" id="service-tab-nav" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="process-nav-3" style="margin-right:-26% !important;" data-bs-toggle="tab" href="#process-tab-3" role="tab" aria-controls="process-tab-3" aria-selected="true">
                        ...
                        <span>Final design delivery </span>
                    </a>
                </li>
            </ul>
            ...
            <div class="tab-content service-tab-content" id="service-tab">
                <div class="tab-pane fade show active" id="process-tab-1" role="tabpanel" aria-labelledby="process-nav-1">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/research.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>Research</h4>
                            <p style="font-family: cursive;">The research process starts with identifying a research problem.</p>
                            <p style="font-family: cursive;">Then a literature review finds the context of this research problem.</p>
                ...
                <div class="tab-pane fade" id="process-tab-2" role="tabpanel" aria-labelledby="process-nav-2">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/creative-process.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>Creative process</h4>
                            <p style="font-family: cursive;">Creative processes tend to go through a series of stages.</p>
                            <p style="font-family: cursive;">A preparation stage involves the acquisition of knowledge, information, or ideas.</p>
                            <a href="#" class="text-only-btn">Next Process
                                <i class="ml-symone-2-arrow-left-right-up-down-increase-decrease"></i>
                            </a>
                        </div>
                ...
                <div class="tab-pane fade" id="process-tab-3" role="tabpanel" aria-labelledby="process-nav-3">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/final-design.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>Final design delivery</h4>
                            <p style="font-family: cursive;">Design Delivery Schedule means the schedule covering design services to be performed by the Design Team</p>
                            <p style="font-family: cursive;"> set forth in the Design Services Agreement, or as otherwise agreed upon by the Architect and the Parties.</p>
                            <a href="#" class="text-only-btn">Next Process
                                <i class="ml-symone-2-arrow-left-right-up-down-increase-decrease"></i>
                            </a>
                        </div>
        ...
        <div class="featured-project-showcase text-center">
            <div class="row equalHeightWrapper">
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/highfit.jpg" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">Logo Design</span>
                            High Fit Gym Logo
                        </h5>
                    </a>
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/nft.jpg" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">NFT Artwork</span>
                            NFT Graffity
                        </h5>
                    </a>
                    <!-- End of .featured-content-block -->
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/be-happy.jpg" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">Logo Design</span>
                            Be Happy Cleaners Logo
                        </h5>
                    </a>
                    <!-- End of .featured-content-block -->
                </div>
