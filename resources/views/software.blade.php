...
<title>Web Development - Digital Agency</title>
...
<div class="xs-inner-banner inner-banner2" style="background-image:url('assets/images/banner/softwarebanner.jpg')">
<div class="container">
<div class="row">
<div class="col-md-7 mx-auto">
<div class="inner-banner">
<h2 class="inner-banner-title">Software Development</h2>
...
<section class="image-with-description">
    ...
    <div class="container">
        <div class="row align-items-center image-with-description-block">
            <div class="col-lg-6">
                <h2 style="font-size:2.8rem !important;">Software Development Process</h2>
                <p style="font-size:-0.2rem !important; font-family: cursive;">Whether you plan it or not, every piece of software goes through a similar path from idea to launch day. Collectively, the steps of this path are called the software development lifecycle (or SDLC for short). The SDLC is the sequence of steps that take place during the development of a piece of software. The Software Development Life Cycle as a collection of rules and practices helps to connect tech, non-tech team members, and project stakeholders to transform your exceptional idea into a unique software product or solution. 
                </p>
                <ul class="common-list-items" style=" font-family: cursive;">
                    <li>
                        <i class="ml-tec-44-responsive-mobile-phone-tablet-computer-desktop-monitor-laptop"></i> Agile Process</li>
                    <li>
                        <i class="ml-tec-47-disc-device-plug-computer-desktop-monitor-laptop"></i> Agility and Project Size Factors</li>
                    <li>
                        <i class="ml-tec-43-computer-desktop-monitor-laptop"></i> Mature Value Delivery Capabilities</li>
                </ul>
            ...
            <div class="col-lg-6 text-lg-right">
                <img src="images/services/softdev.jpg" alt="web design description image" class="img-fluid">
            </div>
            <!-- End of .col-lg-6 -->
        </div>
        <!-- End of .row -->
...
<section class="our-process section-padding">
    <div class="container">
        <h2 class="text-center" style="font-size: 3.5rem !important">Our Steps</h2>
        <p class="section-subheading text-center" style="font-size: 1.4rem !important">Agile software development uses iterative development as a basis but advocates a lighter and more people-centric viewpoint than traditional approaches.</p>

        <div class="service-process-tab">
            <ul class="nav nav-tabs service-tab-nav" id="service-tab-nav" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" style="margin-left:-26% !important;" id="process-nav-1" data-bs-toggle="tab" href="#process-tab-1" role="tab" aria-controls="process-tab-1"
                        aria-selected="true">
                        <i class="ml-edu-86-People"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link" id="process-nav-2" data-bs-toggle="tab" href="#process-tab-2" role="tab" aria-controls="process-tab-2" aria-selected="true">
                        <i class="ml-des-19-Transform-shape-graphics-design-tool-interface"></i>
                        <span>Wire-frame</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="process-nav-3" style="margin-right:-26% !important;" data-bs-toggle="tab" href="#process-tab-3" role="tab" aria-controls="process-tab-3" aria-selected="true">
                        <i class="ml-tec-9-check-mark-yes-computer-desktop-monitor-laptop"></i>
            ...
            <div class="tab-content service-tab-content" id="service-tab">
                <div class="tab-pane fade show active" id="process-tab-1" role="tabpanel" aria-labelledby="process-nav-1">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/softconsult.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>Consultation</h4>
                            <p style="font-family: cursive;">The software consulting process has the same basic steps, regardless of the business type or the company current software situation.</p>
                            <p style="font-family: cursive;">A software consultant must begin by getting a good feel for the company operations and workflow. Once the consultant has a feel for the company workflow and how they are using their current software, they will be well-positioned to explore their pain points. After the consultant has gained insight regarding the company needs and pain points, its time to examine the actual software and IT infrastructure.</p>
                ...
                <div class="tab-pane fade" id="process-tab-2" role="tabpanel" aria-labelledby="process-nav-2">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/softdevwire.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>Wire-frame</h4>
                            <p style="font-family: cursive;">In big companies, most of the developers and designers follow the concept of wireframing. Wireframing gives you an idea of the overall structure of the web pages and how navigation will flow in these pages for a user to perform a specific task.</p>
                            <p style="font-family: cursive;">Where does a certain component or element need to be positioned? Where the images, videos, navigation bar, buttons, and other elements need to be placed. </p>
                            <a href="#" class="text-only-btn">Next Process
                                <i class="ml-symone-2-arrow-left-right-up-down-increase-decrease"></i>
                            </a>
                        </div>
                ...
                <div class="tab-pane fade" id="process-tab-3" role="tabpanel" aria-labelledby="process-nav-3">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/softdeploy.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>Final Design</h4>
                            <p style="font-family: cursive;">Software deployment includes all of the steps, processes, and activities that are required to make a software system or update available to its intended users. </p>
                            <p style="font-family: cursive;">Today, most IT organizations and software developers deploy software updates, patches and new applications with a combination of manual and automated processes.</p>
                            <a href="#" class="text-only-btn">Next Process
                                <i class="ml-symone-2-arrow-left-right-up-down-increase-decrease"></i>
                            </a>
                        </div>
...
<section class="featured-projects section-padding">
    ...
    <div class="container">
        <h2 class="text-center" style="font-size:3.0rem !important;">Featured Designs</h2>
        ...
        <div class="featured-project-showcase text-center">
            <div class="row equalHeightWrapper">
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/featured-project-7.jpg" alt="Project image" class="img-fluid">
                        </div>
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/featured-project-8.jpg" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">Web Design</span>
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/featured-project-10.jpg" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">Web Design</span>
...
<p style="font-family: cursive;">Should you have any queries, please feel free to contact us.
