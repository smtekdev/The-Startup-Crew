...
<title>Book Translate - Digital Agency</title>
...
<div class="xs-inner-banner inner-banner2" style="background-image:url('assets/images/banner/book-translate.jpg')">
<div class="container">
<div class="row">
<div class="col-md-7 mx-auto">
<div class="inner-banner">
<h2 class="inner-banner-title">Book Translation</h2>
...
<section class="image-with-description">
    ...
    <div class="container">
        <div class="row align-items-center image-with-description-block">
            <div class="col-lg-6">
                <h2 style="font-size:2.8rem !important;">Book Translation Research</h2>
                <p style="font-size:-0.2rem !important; font-family: cursive;">Find out where your strongest markets are, Search for book translators with experience, Have a discussion with your shortlist of translators
                    Agree on the scope of the translation work, Start translating the text.
                </p>
                <ul class="common-list-items" style=" font-family: cursive;">
                    <li>
                        <i class="ml-des-21-Transform-shape-graphics-design-tool-interface-layers-tool-bar"></i> Format and publish the translated edition</li>
                    <li>
                        <i class="ml-des-35-divide-unite-intersect-exclude-graphics-design-tool-interface"></i> Check your rights, prices, and taxes</li>
                    <li>
                        <i class="ml-tec-9-check-mark-yes-computer-desktop-monitor-laptop"></i> Effectively market your translation in your target country</li>
                </ul>
            ...
            <div class="col-lg-6 text-lg-right">
                <img src="images/services/book-translate.jpg" alt="web design description image" class="img-fluid">
            </div>
            <!-- End of .col-lg-6 -->
        </div>
        <!-- End of .row -->
...
<section class="our-process section-padding">
    <div class="container">
        ...
        <p class="section-subheading text-center" style="font-size: 1.4rem !important"> If you’re ready to connect with new readers, sell more books,  
            <br>and develop your author brand and global footprint.</p>
        ...
        <div class="service-process-tab">
            <ul class="nav nav-tabs service-tab-nav" id="service-tab-nav" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="process-nav-2" data-bs-toggle="tab" href="#process-tab-2" role="tab" aria-controls="process-tab-2" aria-selected="true">
                        ...
                        <span>Search for translators</span>
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content service-tab-content" id="service-tab">
                <div class="tab-pane fade show active" id="process-tab-1" role="tabpanel" aria-labelledby="process-nav-1">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/find-market.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>Find Market</h4>
                            <p style="font-family: cursive;">“Know your audience” is a maxim that you probably already recognize as an author.</p>
                            <p style="font-family: cursive;">It’s important when you’re writing and selling a book in your own country, and doubly so when you’re selling a book abroad.</p>
                ...
                <div class="tab-pane fade" id="process-tab-2" role="tabpanel" aria-labelledby="process-nav-2">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/search-translator.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>Search for translators</h4>
                            <p style="font-family: cursive;">Just in case it needs to be said: don’t translate your book yourself. Just don’t do it. Don’t even attempt it</p>
                            <p style="font-family: cursive;">If you’re serious about producing a quality translation of your book, there’s no real replacement for a professional literary translator.</p>
                            <a href="#" class="text-only-btn">Next Process
                                <i class="ml-symone-2-arrow-left-right-up-down-increase-decrease"></i>
                            </a>
                        </div>
                ...
                <div class="tab-pane fade" id="process-tab-3" role="tabpanel" aria-labelledby="process-nav-3">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-5 text-lg-right">
                            <img src="images/services/process-tab/web-design-process/start-translate.jpg" alt="Process image" class="img-fluid">
                        </div>
                        <!-- End of .col-lg-6 -->

                        <div class="col-lg-6 offset-lg-1 text-center text-lg-left">
                            <h4>Start translating</h4>
                            <p style="font-family: cursive;">Like other publishing professionals, such as developmental editors and book designers, translators work pretty closely with authors during their collaborations.</p>
                            <p style="font-family: cursive;">The translator’s job is to faithfully carry over your story and voice into the translation</p>
                            <a href="#" class="text-only-btn">Next Process
                                <i class="ml-symone-2-arrow-left-right-up-down-increase-decrease"></i>
                            </a>
                        </div>
        ...
        <div class="featured-project-showcase text-center">
            <div class="row equalHeightWrapper">
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/book-pro1.jpg" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">Book Translation</span>
                            Simple Path to More Profit
                        </h5>
                    </a>
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/book-pro2.jpg" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">Book Translation</span>
                ...
                <div class="grid-item col-md-6 col-lg-4">
                    <a href="#" class="featured-content-block content-block" data-bs-toggle="modal" data-bs-target="#featured-project-modal">
                        <div class="img-container">
                            <img src="images/featured-projects/book-pro3.jpg" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            <span class="content-block__sub-title">Book Translation</span>
